          ...
          <div className="glass-panel ambient-shadow rounded-3xl p-8 md:p-12 border border-white/20">
            ...
            <form className="space-y-6">
              ...
              <div className="pt-6 space-y-4">
                <Link to="/dashboard" className="block text-center w-full py-4 rounded-xl teal-gradient text-on-primary font-bold text-base shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 active:scale-[0.98] transition-all duration-200">
                  Login
                </Link>
